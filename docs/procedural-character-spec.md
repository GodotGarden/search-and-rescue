...
See [Procedural Preview Lab](specifications/procedural-preview-lab.md) for the dev-time tooling used to iterate on this rig and its visual passes without entering gameplay.
